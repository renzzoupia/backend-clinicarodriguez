...
public interface MedicosEspecialidadesRepository extends JpaRepository<MedicosEspecialidades, Integer> {
    ...
    List<MedicosEspecialidades> findByMedicoId(@Param("medicoId") Integer medicoId);
    ...
    List<MedicosEspecialidades> findByEspecialidadId(@Param("especialidadId") Integer especialidadId);
    ...
    boolean existsByMedicoAndEspecialidad(@Param("medicoId") Integer medicoId, @Param("especialidadId") Integer especialidadId);
}
